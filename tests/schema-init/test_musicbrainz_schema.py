...
def test_relationships_has_unique_constraint():
    # discogsography-dgtg: the natural key must include begin_date/end_date/attributes
...
def test_relationships_natural_key_migration_present():
    # discogsography-dgtg: existing databases carry the old, narrower autogenerated
