...
authority, for 80 commits total. No source tags were present or copied.
...
- the existing PolyForm Noncommercial 1.0.0 license and required notice are preserved;
...
- gitleaks history scan: 80 commits scanned, no leaks;
...
- GitHub Actions CI run `33043749741`: passed;
