...
uv run python -m investigations.benchmark.runner --backend age --host localhost:5434 --scale small --load
uv run python -m investigations.benchmark.runner --backend age --host localhost:5434 --scale small
uv run python -m investigations.benchmark.runner --backend age --host localhost:5434 --scale large --load
uv run python -m investigations.benchmark.runner --backend age --host localhost:5434 --scale large

uv run python -m investigations.benchmark.compare investigations/results/neo4j_*.json investigations/results/age_*.json
```
