...
async def _run_query(driver: AsyncResilientNeo4jDriver, cypher: str, *, timeout: float | None = 120, **params: Any) -> list[dict[str, Any]]:
...
async def _run_count(driver: AsyncResilientNeo4jDriver, cypher: str, *, timeout: float | None = 120, **params: Any) -> int:
